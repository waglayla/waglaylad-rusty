...
(async () => {
    ...
    //     extraData:[],
    //     payAddress:"waglayla:qrwee7xc2qw5whq8qzv82qjld6zunwy46lsy3hueej5kvgfwvamhswy03lsyh"
    // });
    ...
    const addr = address ?? "waglaylatest:qz7ulu4c25dh7fzec9zjyrmlhnkzrg4wmf89q7gzr3gfrsj3uz6xjceef60sd";

    const addresses = [
        addr,
        //new Address("waglaylatest:qz7ulu4c25dh7fzec9zjyrmlhnkzrg4wmf89q7gzr3gfrsj3uz6xjceef60sd")
    ];
    ...
    // let outputs = [
    //     new waglayla.TransactionOutput(300n, new waglayla.ScriptPublicKey(0, keypair3.publicKey)),
    //     {
    //         value: 300n,
    //         scriptPublicKey : new waglayla.ScriptPublicKey(0, keypair3.publicKey)
    //     },
    // ];
