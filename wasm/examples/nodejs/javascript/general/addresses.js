let waglayla = require('../../../../nodejs/waglayla');
let {
    PrivateKey,
    PublicKey,
    PublicKeyGenerator,
...
// Getting Waglayla Address from Private Key
...
function demoGenerateAddressFromPublicKeyHexString() {
    ...
    console.info(publicKey.toAddress(NetworkType.Mainnet).toString() == 'waglayla:qr0lr4ml9fn3chekrqmjdkergxl93l4wrk3dankcgvjq776s9wn9jkdskewva');
    ...
    console.info(xOnlyPublicKey.toAddress(NetworkType.Mainnet).toString() == 'waglayla:qr0lr4ml9fn3chekrqmjdkergxl93l4wrk3dankcgvjq776s9wn9jkdskewva');
    ...
    console.info(fullDERPublicKey.toAddress(NetworkType.Mainnet).toString() == 'waglayla:qqs7krzzwqfgk9kf830smtzg64s9rf3r0khfj76cjynf2pfgrr35saatu88xq');
}