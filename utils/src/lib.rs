...
/// #[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize)]
/// struct TestStruct {
///     #[serde(with = "waglayla_utils::serde_bytes_fixed")]
///     v: [u8; 20],
/// }
...
///     }
/// }
/// impl waglayla_utils::hex::FromHex for MyStruct {
...
///     }
/// }
/// waglayla_utils::serde_impl_ser_fixed_bytes_ref!(MyStruct, 20);
/// waglayla_utils::serde_impl_deser_fixed_bytes_ref!(MyStruct, 20);
///
...
/// #[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize)]
/// struct TestStruct {
///     #[serde(with = "waglayla_utils::serde_bytes_fixed_ref")]
///     v: MyStruct,
/// }
///
