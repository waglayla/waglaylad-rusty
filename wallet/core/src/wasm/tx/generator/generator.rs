...
interface IGeneratorSettingsObject {
     ...
     * 
     * Typical usage: { address: "waglayla:...", amount: 1000n }
     */
...
///     utxoEntries : [...],
///     changeAddress : "waglayla:...",
///     outputs : [
///         { amount : waglaylaToSompi(10.0), address: "waglayla:..."},
///         { amount : waglaylaToSompi(20.0), address: "waglayla:..."},
///         ...
///     ],
///     priorityFee : 1000n,
/// });
