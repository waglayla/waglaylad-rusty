...
pub struct DerivationPath {
    inner: waglayla_bip32::DerivationPath,
}
...
impl DerivationPath {
    ...
    pub fn new(path: &str) -> Result<DerivationPath> {
        let inner = waglayla_bip32::DerivationPath::from_str(path)?;
        Ok(Self { inner })
    }
...
impl<'a> From<&'a DerivationPath> for &'a waglayla_bip32::DerivationPath {
