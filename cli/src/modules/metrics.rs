use crate::imports::*;
use waglayla_metrics_core::{Metrics as MetricsProcessor, MetricsSinkFn};
...
impl Metrics {
    ...
    pub async fn display_help(self: &Arc<Self>, ctx: Arc<WaglaylaCli>, _argv: Vec<String>) -> Result<()> {
