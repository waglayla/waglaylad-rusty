...
macro_rules! trace {
    ($($t:tt)*) => {
        if waglayla_core::log::workflow_log::log_level_enabled(log::Level::Trace) {
            waglayla_core::log::workflow_log::impls::trace_impl(None, &format_args!($($t)*));
        }
    };
}
...
macro_rules! debug {
    ($($t:tt)*) => (
        if waglayla_core::log::workflow_log::log_level_enabled(log::Level::Debug) {
            waglayla_core::log::workflow_log::impls::debug_impl(None, &format_args!($($t)*));
        }
    )
}
...
macro_rules! info {
    ($($t:tt)*) => (
        if waglayla_core::log::workflow_log::log_level_enabled(log::Level::Info) {
            waglayla_core::log::workflow_log::impls::info_impl(None, &format_args!($($t)*));
        }
    )
}
...
macro_rules! warn {
    ($($t:tt)*) => (
        if waglayla_core::log::workflow_log::log_level_enabled(log::Level::Warn) {
            waglayla_core::log::workflow_log::impls::warn_impl(None, &format_args!($($t)*));
        }
    )
}
...
macro_rules! error {
    ($($t:tt)*) => (
        if waglayla_core::log::workflow_log::log_level_enabled(log::Level::Error) {
            waglayla_core::log::workflow_log::impls::error_impl(None, &format_args!($($t)*));
        }
    )
}
