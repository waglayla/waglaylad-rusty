...
/// The main object to create for managing a fully-fledged Waglayla P2P peer
pub struct Adaptor {
    //
...
impl Adaptor {
    ...
    /// Creates a P2P adaptor with only client-side support. Typical Waglayla nodes should use `Adaptor::bidirectional`
