...
use waglayla_consensus_core::subnets::{self, SubnetworkId};
use waglayla_consensus_core::tx::UtxoEntry;
use waglayla_txscript::extract_script_pub_key_address;
...
impl Transaction {
    ...
    pub fn addresses(&self, network_type: &NetworkTypeT) -> Result<waglayla_addresses::AddressArrayT> {
