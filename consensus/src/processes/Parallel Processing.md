...
## Sequential processing flow (in go-waglaylad)

Below we detail the current state of affairs in *go-waglaylad* and discuss future parallelism opportunities. Processing dependencies between various stages are detailed in square brackets [***deps; type***].
...
The current code design (*go-waglaylad*) already logically supports this since the various processing stages were already decoupled for supporting efficient IBD.
