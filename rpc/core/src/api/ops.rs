...
pub enum RpcApiOps {
    ...
    GetSyncStatus,
    /// Returns the network this Waglayla is connected to (Mainnet, Testnet)
    GetCurrentNetwork,
    ...
    GetBlockTemplate,
    /// Returns a list of all the addresses (IP, port) this Waglaylad knows and a list of all addresses that are currently banned by this Waglaylad
    GetPeerAddresses,
    ...
    GetMempoolEntries,
    /// Returns a list of the peers currently connected to this Waglaylad, along with some statistics on them
    GetConnectedPeerInfo,
    /// Instructs Waglaylad to connect to a given IP address.
    AddPeer,
