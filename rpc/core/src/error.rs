...
use waglayla_consensus_core::{subnets::SubnetworkConversionError, tx::TransactionId};
...
pub enum RpcError {
    ...
    #[error(transparent)]
    NetworkTypeError(#[from] waglayla_consensus_core::network::NetworkTypeError),

    #[error(transparent)]
    NetworkIdError(#[from] waglayla_consensus_core::network::NetworkIdError),

    #[error(transparent)]
    NotificationError(#[from] waglayla_notify::error::Error),

    #[error(transparent)]
    MiningManagerError(#[from] waglayla_mining_errors::manager::MiningManagerError),

    #[error(transparent)]
    ConsensusError(#[from] waglayla_consensus_core::errors::consensus::ConsensusError),

    #[error(transparent)]
    ScriptClassError(#[from] waglayla_txscript::script_class::Error),
