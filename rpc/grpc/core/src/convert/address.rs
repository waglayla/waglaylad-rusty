...
from!(item: &waglayla_rpc_core::RpcBalancesByAddressesEntry, protowire::RpcBalancesByAddressesEntry, {
...
try_from!(item: &protowire::RpcBalancesByAddressesEntry, waglayla_rpc_core::RpcBalancesByAddressesEntry, {
