...
from!(item: &waglayla_rpc_core::ConnectionMetrics, protowire::ConnectionMetrics, {
    Self {
...
from!(item: &waglayla_rpc_core::BandwidthMetrics, protowire::BandwidthMetrics, {
    Self {
...
from!(item: &waglayla_rpc_core::ConsensusMetrics, protowire::ConsensusMetrics, {
    Self {
...
try_from!(item: &protowire::ConnectionMetrics, waglayla_rpc_core::ConnectionMetrics, {
    Self {
        borsh_live_connections: item.borsh_live_connections,
        borsh_connection_attempts: item.borsh_connection_attempts,
        borsh_handshake_failures: item.borsh_handshake_failures,
...
try_from!(item: &protowire::BandwidthMetrics, waglayla_rpc_core::BandwidthMetrics, {
    Self {
        borsh_bytes_tx: item.borsh_bytes_tx,
        borsh_bytes_rx: item.borsh_bytes_rx,
        json_bytes_tx: item.json_bytes_tx,
...
try_from!(item: &protowire::ConsensusMetrics, waglayla_rpc_core::ConsensusMetrics, {
    Self {
