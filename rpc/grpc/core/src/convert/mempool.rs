...
from!(item: &waglayla_rpc_core::RpcMempoolEntry, protowire::RpcMempoolEntry, {
    Self { fee: item.fee, transaction: Some((&item.transaction).into()), is_orphan: item.is_orphan }
});

from!(item: &waglayla_rpc_core::RpcMempoolEntryByAddress, protowire::RpcMempoolEntryByAddress, {
    Self {
...
try_from!(item: &protowire::RpcMempoolEntry, waglayla_rpc_core::RpcMempoolEntry, {
    Self::new(
        item.fee,
        item.transaction
            .as_ref()
...
try_from!(item: &protowire::RpcMempoolEntryByAddress, waglayla_rpc_core::RpcMempoolEntryByAddress, {
    Self::new(
