...
use waglayla_txscript::{get_sig_op_count, is_unspendable, script_class::ScriptClass};
...
mod tests {
    ...
    fn test_check_transaction_standard_in_isolation() {
        ...
        let dummy_script_public_key = waglayla_txscript::pay_to_address_script(&addr);
        let dummy_tx_out = TransactionOutput::new(SOMPI_PER_WAGLAYLA, dummy_script_public_key);
