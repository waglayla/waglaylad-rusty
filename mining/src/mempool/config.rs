use waglayla_consensus_core::constants::TX_VERSION;
...
// TODO: when waglayla nodes run most of the network, consider increasing this value
...
impl Config {
    ...
    /// The arguments should be obtained from the current consensus [`waglayla_consensus_core::config::params::Params`] instance.
